  ...
  return (
    <div className='font-link'>
      ...
      <div className='leaders d-flex'>
        <div className='row'>
          <div className='col-md-3 px-2'><img src={chairman} class="rounded float-start img-fluid" alt="img"/></div>
          <div className='info-box col-md-9 pt-3 px-3'>
      ...
      <div className='leaders'>
        <div className='row'>
          ...
          <div className='col-md-3'><img src={ceo} class="rounded float-end img-fluid" alt="img"/></div>
        </div>
      </div>
    </div>
  )
