...
const OperatingUnit = () => {
  return (
    <div className='font-link'>
        ...
        <div className='ou'>
            <div className='row'>
                <div className='col-md-3'><img src={AOU} class="rounded float-start img-fluid" alt="img"/></div>
        ...
        <div className='ou'>
            <div className='row'>
                ...
                <div className='col-md-3'><img src={COU} class="rounded float-end img-fluid" alt="img"/></div>
            </div>
        </div>
        <div className='ou'>
            <div className='row'>
                <div className='col-md-3'><img src={GOU} class="rounded float-start img-fluid" alt="img"/></div>
                <div className='col-md-9 pt-3'>
        ...
        <div className='ou'>
            <div className='row'>
                ...
                <div className='col-md-3'><img src={ITS} class="rounded float-end img-fluid" alt="img"/></div>
            </div>
        </div>
        <div className='ou'>
            <div className='row'>
                <div className='col-md-3'><img src={KO} class="rounded float-start img-fluid" alt="img"/></div>
                <div className='col-md-9 pt-3'>
        ...
        <div className='ou'>
            <div className='row'>
                ...
                <div className='col-md-3'><img src={ROU} class="rounded float-end img-fluid" alt="img"/></div>
            </div>
        </div>
        <div className='ou'>
            <div className='row'>
                <div className='col-md-3'><img src={CF} class="rounded float-start img-fluid" alt="img"/></div>
                <div className='col-md-9 pt-3'>
