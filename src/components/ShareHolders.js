...
const ShareHolders = () => {
  return (
    <div className='font-link'>
        ...
        <div className='share'>
            <div className='row'>
                <div className='col-md-3'><img src={gok} class="rounded float-start img-fluid" alt="img"/></div>
        ...
        <div className='share'>
            <div className='row'>
                ...
                <div className='col-md-3'><img src={goi} class="rounded float-end img-fluid" alt="img"/></div>
            </div>
        </div>
        <div className='share'>
            <div className='row'>
                <div className='col-md-3'><img src={tcs} class="rounded float-start img-fluid" alt="img"/></div>
                <div className='col-md-9 pt-3'>
        ...
        <div className='share'>
            <div className='row'>
                ...
                <div className='col-md-3'><img src={sei} class="rounded float-end img-fluid" alt="img"/></div>
            </div>
        </div>
        <div className='share'>
            <div className='row'>
                <div className='col-md-3'><img src={ust} class="rounded float-start img-fluid" alt="img"/></div>
                <div className='col-md-9 pt-3'>
                    <h2>UST Global</h2>
        ...
        <div className='share'>
            <div className='row'>
                ...
                <div className='col-md-3'><img src={ibs} class="rounded float-end img-fluid" alt="img"/></div>
            </div>
        </div>
        <div className='share'>
            <div className='row'>
                <div className='col-md-3'><img src={quest} class="rounded float-start img-fluid" alt="img"/></div>
                <div className='col-md-9 pt-3'>
                    <h2>QuEST Global</h2>
